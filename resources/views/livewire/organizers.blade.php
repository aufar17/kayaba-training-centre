<div>
    <x-card :icon="'fa-table'">
        ...
        @slot('body')
        <button class="btn btn-success border-0 mb-5" data-bs-toggle="modal" data-bs-target="#newLocationModal">
        ...
        <div wire:ignore.self class="modal fade" id="newLocationModal" tabindex="-1"
        ...
        <div wire:ignore.self class="modal fade" id="editLocationModal" tabindex="-1"
        ...
        <div wire:ignore.self class="modal fade" id="deleteLocationModal" tabindex="-1"
            aria-labelledby="deleteLocationModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-md">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title text-white" id="deleteLocationModalLabel">Delete Confirmation</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
