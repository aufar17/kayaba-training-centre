                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('training-content', $now->id) }}"
                                    class="btn btn-success btn-sm shadow-lg me-2">
                                    <i class="fa-solid fa-eye me-1"></i> Content
                                </a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('training-content', $upcoming->id) }}"
                                    class="btn btn-info btn-sm shadow-lg me-2">
                                    <i class="fa-solid fa-cash-register me-1"></i> Content
                                </a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('training-content', $past->id) }}"
                                    class="btn btn-secondary btn-sm shadow-lg me-2">
                                    <i class="fa-solid fa-eye me-1"></i> Content
                                </a>
