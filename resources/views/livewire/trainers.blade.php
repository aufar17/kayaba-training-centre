<div>
    <x-card :icon="'fa-table'">
        ...
        @slot('body')
        <button class="btn btn-success border-0 mb-5" data-bs-toggle="modal" data-bs-target="#newTrainerModal">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button wire:click="confirmDelete({{ $trainer->id }})"
        ...
        <div wire:ignore.self class="modal fade" id="newTrainerModal" tabindex="-1"
            aria-labelledby="newTrainerModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content border-0 shadow-md">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title text-white" id="newTrainerModalLabel">Add New Trainer</h5>
        ...
        <div wire:ignore.self class="modal fade" id="editTrainerModal" tabindex="-1"
            aria-labelledby="editTrainerModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content border-0 shadow-md">
                    <div class="modal-header bg-warning text-white">
                        <h5 class="modal-title text-white" id="editTrainerModalLabel">Edit Trainer</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
        ...
        <div wire:ignore.self class="modal fade" id="deleteTrainerModal" tabindex="-1"
            aria-labelledby="deleteTrainerModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-md">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title text-white" id="deleteTrainerModalLabel">Delete Confirmation</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
